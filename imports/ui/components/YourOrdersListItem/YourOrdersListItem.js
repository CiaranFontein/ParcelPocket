    ...
    logButton = (
      <React.Fragment>
        <button
          ...
          onClick={() => {
            Meteor.call("users.addRating", order.recipient, (err, res) => {
              console.log(err, res);
            });
            Meteor.call("orders.changeStatusToFinished", order, (err, res) => {
              console.log(err, res);
            });
          }}
        >
        ...
        <button
          ...
          onClick={() => {
            Meteor.call("users.subtractRating", order.recipient, (err, res) => {
              console.log(err, res);
            });
            Meteor.call("orders.changeStatusToFinished", order, (err, res) => {
              console.log(err, res);
